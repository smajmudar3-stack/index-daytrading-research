...
This is a study, not a live engine: it downloads 20 years of history and prints a
table. It was filed in 04_live_system/ by the bundle split, where it imported a
module that lived in 05_studies/ and so could not run from either directory.
"""
import numpy as np
import pandas as pd  # noqa: F401  (unused here; left as it was found)
