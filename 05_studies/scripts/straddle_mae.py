...
SYM = "SPY"
df = pd.read_parquet(f"/Users/sahilmajmudar/index-daytrading/data/opt_eod/{SYM}_monthly_full.parquet")
df["mid"] = (df["bid"] + df["ask"]) / 2
und = pd.read_parquet(f"/Users/sahilmajmudar/index-daytrading/data/opt_eod/{SYM}_underlying.parquet")
