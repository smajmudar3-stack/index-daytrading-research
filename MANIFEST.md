...
| `02_findings/INTRADAY_DIRECTION.md` | 351 | 16 KB |
| `02_findings/METHODOLOGY_TRAPS.md` | 191 | 8 KB |
...
| `03_research/RESEARCH_EVERY_MARKET.md` | 138 | 9 KB |
...
| `03_research/RESEARCH_WEEKLY_PREDICTORS.md` | 159 | 13 KB |

## 04_live_system — the dashboard and its engines

*82 files, 23,410 lines*

| file | lines | size |
|---|---:|---:|
| `04_live_system/INDEX.md` | 71 | 7 KB |
...
| `04_live_system/edge_rules.py` | 195 | 9 KB |
| `04_live_system/fetch_minutes.py` | 179 | 8 KB |
| `04_live_system/flow_tape.py` | 193 | 8 KB |
| `04_live_system/gap_dashboard.py` | 1,601 | 102 KB |
| `04_live_system/gap_gamma.py` | 53 | 3 KB |
| `04_live_system/gap_scanner.py` | 533 | 28 KB |
...
| `04_live_system/kalshi_recorder.py` | 187 | 9 KB |
| `04_live_system/lessons.py` | 196 | 9 KB |
| `04_live_system/macro_calendar.py` | 252 | 11 KB |
...
| `04_live_system/uw_calibrate.py` | 235 | 9 KB |
| `04_live_system/uw_client.py` | 560 | 27 KB |
| `04_live_system/uw_endpoints.py` | 399 | 19 KB |
| `04_live_system/watch_ndx.py` | 60 | 2 KB |
| `04_live_system/weekly_book.py` | 693 | 31 KB |
| `04_live_system/weekly_structures.py` | 351 | 18 KB |
| `04_live_system/weekly_swing.py` | 2,539 | 131 KB |
...
| `04_live_system/panels/markets.py` | 242 | 12 KB |
...
| `04_live_system/templates/view.html` | 4 | 122 B |
...
| `04_live_system/templates/panels/weekly_trades.html` | 127 | 7 KB |
...
| file | lines | size |
|---|---:|---:|
| `04_live_system/static/app.css` | 676 | 37 KB |
| `04_live_system/static/app.js` | 124 | 4 KB |

## 05_studies — backtest and hunt harnesses

*70 files, 10,852 lines*

| file | lines | size |
|---|---:|---:|
| `05_studies/INDEX.md` | 166 | 18 KB |
...
| `05_studies/engine_combo_test.py` | 90 | 4 KB |
| `05_studies/engine_d_influencers.py` | 402 | 17 KB |
| `05_studies/engine_e_feasibility.py` | 356 | 16 KB |
| `05_studies/final_system.py` | 40 | 2 KB |
| `05_studies/fomc_research.py` | 89 | 5 KB |
| `05_studies/gap_direction_test.py` | 213 | 9 KB |
| `05_studies/gxz_straddle_test.py` | 132 | 7 KB |
...
| `05_studies/kalshi_score.py` | 50 | 3 KB |
...
| `05_studies/xsec_diffusion_test.py` | 112 | 6 KB |
...
| `05_studies/xsec_uw_test.py` | 177 | 9 KB |
...
| `05_studies/scripts/accuracy_hurdle.py` | 128 | 6 KB |
...
| `05_studies/scripts/breakout_tradeable.py` | 118 | 5 KB |
...
| `05_studies/scripts/diagnose_1300.py` | 130 | 5 KB |
...
| `05_studies/scripts/gao_corrected.py` | 140 | 5 KB |
| `05_studies/scripts/gao_intraday_momentum.py` | 120 | 5 KB |
| `05_studies/scripts/gex_structures_test.py` | 207 | 9 KB |
| `05_studies/scripts/intraday_inventory.py` | 60 | 2 KB |
| `05_studies/scripts/intraday_inventory2.py` | 56 | 2 KB |
| `05_studies/scripts/intraday_predict_matrix.py` | 146 | 6 KB |
...
| `05_studies/scripts/mirror_drift_control.py` | 122 | 5 KB |
| `05_studies/scripts/mirror_test.py` | 108 | 5 KB |
| `05_studies/scripts/move_distribution.py` | 107 | 4 KB |
| `05_studies/scripts/nge_proper.py` | 148 | 6 KB |
| `05_studies/scripts/nge_validate.py` | 131 | 5 KB |
| `05_studies/scripts/openalex_gap.py` | 78 | 3 KB |
| `05_studies/scripts/openalex_lit.py` | 90 | 4 KB |
...
| `05_studies/scripts/outlier_day_effect.py` | 104 | 4 KB |
...
| `05_studies/scripts/spinoff_edgar_harvest.py` | 377 | 17 KB |
...
| `05_studies/scripts/theta_hurdle.py` | 108 | 5 KB |
...
## 07_research_bank — other

*1 files, 238 lines*

| file | lines | size |
|---|---:|---:|
| `07_research_bank/README.md` | 238 | 11 KB |

## 07_research_bank/reports — other

*17 files, 2,953 lines*

| file | lines | size |
|---|---:|---:|
| `07_research_bank/reports/01_kelly_ruin.md` | 162 | 6 KB |
| `07_research_bank/reports/02_github_repos.md` | 162 | 8 KB |
| `07_research_bank/reports/03_forums_communities.md` | 183 | 8 KB |
| `07_research_bank/reports/04_event_driven.md` | 193 | 9 KB |
| `07_research_bank/reports/05_new_domains.md` | 184 | 9 KB |
| `07_research_bank/reports/06_crypto_convexity.md` | 141 | 6 KB |
| `07_research_bank/reports/07_warrants.md` | 188 | 8 KB |
| `07_research_bank/reports/08_prop_firms.md` | 179 | 7 KB |
| `07_research_bank/reports/09_capacity_edges.md` | 168 | 8 KB |
| `07_research_bank/reports/10_volarb_section1256.md` | 151 | 7 KB |
| `07_research_bank/reports/11_crash_winners.md` | 170 | 8 KB |
| `07_research_bank/reports/12_optimal_betting.md` | 191 | 8 KB |
| `07_research_bank/reports/13_base_rates.md` | 175 | 7 KB |
| `07_research_bank/reports/14_convexity_base_rates.md` | 256 | 10 KB |
| `07_research_bank/reports/15_forced_sellers.md` | 121 | 5 KB |
| `07_research_bank/reports/16_rates_convexity.md` | 173 | 7 KB |
| `07_research_bank/reports/17_prediction_markets.md` | 156 | 6 KB |

## 07_research_bank/synthesis — other

*3 files, 344 lines*

| file | lines | size |
|---|---:|---:|
| `07_research_bank/synthesis/SYNTHESIS.md` | 216 | 9 KB |
| `07_research_bank/synthesis/TEST_RESULT.md` | 76 | 3 KB |
| `07_research_bank/synthesis/tenx_baseline.txt` | 52 | 3 KB |
...
| file | lines | size |
|---|---:|---:|
| `influencers/registry.yaml` | 374 | 14 KB |
